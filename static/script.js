...
const populateBotResponse = async (userMessage) => {
  ...
  if (isFirstMessage) {
    response = { botResponse: "Halo! Saya adalah asisten data Anda yang ramah, siap menjawab semua pertanyaan mengenai data Anda. Bisakah Anda mengunggah file PDF untuk saya analisis??"};
    uploadButtonHtml = `
